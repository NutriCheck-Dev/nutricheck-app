...
fun HistoryPage(
    ...
    Column(
        ...
        MealBlock(modifier = Modifier.padding(7.dp),
            stringResource(id = R.string.historypage_breakfast), breakfastCalories, items = breakfastComponents, onAddClick = { historyViewModel.onEvent(HistoryEvent.AddEntryClick(selectedDate, DayTime.BREAKFAST))})
        Spacer(modifier = Modifier.height(5.dp))
        MealBlock(modifier = Modifier.padding(7.dp), stringResource(id = R.string.historypage_lunch), lunchCalories, items= lunchComponents, onAddClick = { historyViewModel.onEvent(HistoryEvent.AddEntryClick(selectedDate, DayTime.LUNCH))})
        Spacer(modifier = Modifier.height(5.dp))
        MealBlock(modifier = Modifier.padding(7.dp), stringResource(id = R.string.historypage_dinner), dinnerCalories, items = dinnerComponents, onAddClick = { historyViewModel.onEvent(HistoryEvent.AddEntryClick(selectedDate, DayTime.DINNER))})
        Spacer(modifier = Modifier.height(5.dp))
        MealBlock(modifier = Modifier.padding(7.dp), stringResource(id = R.string.historypage_snack), snackCalories, items = snackComponents, onAddClick = { historyViewModel.onEvent(HistoryEvent.AddEntryClick(selectedDate, DayTime.SNACK))})
    }
}
